...
<secion class="corona_update ">
        <div class="m-4">
            <h3 class="text-center text-uppercase color" style="color: red;" >Covid-19 Live Day Wise Updates of the India</h3>
        </div>
        ...
        <div class="table-responsive">
            ...
            $daycount = count($daywise['cases_time_series']);
            ...
            while($i <  $daycount){
                ...
                <tr class="text-capitalize text-while">
                ...
                <tr class="mb-5">
                    ...
                    <td style="background: #bed2f3;"> <?php echo $daywise['cases_time_series'][$i]['totalrecovered']."<br>"; ?> </td>
